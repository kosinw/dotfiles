...
hi Inactive guibg=#212333 guifg=#929dcb
...
" Set NERDTree statusline
function! NERDInactiveLine()
  " Set empty statusline and colors
  let statusline = ""
  let statusline .= "%#Base#"

  " NERDTree title
  let statusline .= "%#Inactive# NERDTree "
...
augroup Statusline
	...
	autocmd WinEnter,BufEnter * if &ft ==# 'nerdtree' | setlocal statusline=%!NERDLine() | endif
	autocmd WinLeave,BufLeave * if &ft ==# 'nerdtree' | setlocal statusline=%!NERDInactiveLine() | endif
augroup END
